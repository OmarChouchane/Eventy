    ...
    <>
      ...
      <section className="flex justify-center bg-primary-50 bg-dotted-pattern bg-contain">
        <div className="grid grid-cols-1 md:grid-cols-2 2xl:max-w-7xl">
          ...
          <div className="flex w-full flex-col gap-8 p-5 md:p-10 lg:ml-10">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="p-medium-16 lg:p-regular-18 truncate text-primary-500 underline"><a href={event.url}>learn more</a></p>
            </div>
          </div>
        </div>
      </section>
