...
type ImgLogoItem = Extract<LogoItem, { src: string }>;
const isNodeLogo = (item: LogoItem): item is NodeLogoItem =>
      ...
      (item: LogoItem, key: React.Key) => {
        ...
        const content = isNodeItem ? (
          ...
          <Image
            ...
            src={(item as ImgLogoItem).src}
            sizes={(item as ImgLogoItem).sizes}
            width={(item as ImgLogoItem).width ?? 120}
            height={(item as ImgLogoItem).height ?? logoHeight}
            alt={(item as ImgLogoItem).alt ?? ""}
            title={(item as ImgLogoItem).title}
            loading="lazy"
          />
        );
        ...
        const itemAriaLabel = isNodeItem
          ...
          : (item as ImgLogoItem).alt ?? (item as ImgLogoItem).title;
