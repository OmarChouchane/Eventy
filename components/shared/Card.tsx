...
const Card = async ({
  ...
  return (
    <SpotlightCard
      className="group relative flex min-h-[380px] w-full max-w-[400px] flex-col overflow-hidden rounded-xl bg-black shadow-md transition-all hover:shadow-lg md:min-h-[438px]"
