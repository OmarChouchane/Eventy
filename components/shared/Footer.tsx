...
const Footer = () => {
  return (
    <footer className="border-t border-gray-800 bg-gradient-to-tr from-[#0a1437]/95 via-[#1a237e]/90 to-[#00007c]/80 text-gray-200 shadow-2xl shadow-gray-900/40 rounded-t-3xl backdrop-blur-xl bg-opacity-95">
      ...
      />
      <span className="text-xl font-bold text-white  sm:inline">Eventy</span>
      </Link>
      </div>
      ...
      <a href="https://github.com/OmarChouchane/Eventy" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
      <svg className="w-5 h-5 hover:text-white transition" fill="currentColor" viewBox="0 0 24 24">
