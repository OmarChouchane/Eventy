  ...
  return (
    <header className="w-full bg-transparent">
      <div className="wrapper py-3">
        <div className="mx-auto flex items-center justify-between rounded-full border border-white/40 bg-white/5 px-4 py-5 backdrop-blur-md shadow-sm max-w-4xl text-white">
